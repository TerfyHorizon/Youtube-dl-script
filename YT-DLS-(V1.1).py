...
def download_video(download_type, audio_format, url, base_output_dir):
    print("\nStarting download...")

    # Set the specific output directory for the format
    output_dir = os.path.join(base_output_dir, audio_format.upper())
...
if __name__ == "__main__":
    ...
    # Step 4: Set base output directory
    base_output_dir = r"D:\YT-DLP\Audio\Script-dlp"  # Change this to your desired base output path
    os.makedirs(base_output_dir, exist_ok=True)  # Create the base output directory if it doesn't exist

    # Step 5: Start the download
    download_video(download_type, audio_format, url, base_output_dir)
